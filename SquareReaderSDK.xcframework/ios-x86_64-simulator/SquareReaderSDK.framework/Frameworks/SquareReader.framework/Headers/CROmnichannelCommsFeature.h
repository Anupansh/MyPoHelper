 ...
 */
- (void)omnichannelCommsFeature:(CROmnichannelCommsFeature *)feature didReceiveInputRequestWithPaymentCard:(CRPaymentCard *)paymentCard bypassAllowed:(BOOL)bypassAllowed lastAttempt:(BOOL)lastAttempt;
