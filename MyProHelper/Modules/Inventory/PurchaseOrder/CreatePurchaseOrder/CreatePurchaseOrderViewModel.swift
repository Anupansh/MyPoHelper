//
//  CreatePurchaseOrderViewModel.swift
//  MyProHelper
//
...
class CreatePurchaseOrderViewModel: BaseAttachmentViewModel {
...
//                self.vendors = vendors
    ...
    private func updatePurchaseOrder(completion: @escaping (_ error: String?) -> ()) {
        ...
        purchaseOrderService.updatePurchaseOrder(purchaseOrder: purchaseOrder) { [weak self] (result) in
            guard let self = self else { return }
            switch result {
            case .success:
