//
//  CreatedPurchaseOrderLineItem.swift
//  MyProHelper
//
...
private enum LineItemCell: String {
    ...
    case PART_NUMBER            = "PART NUMBER"
    case QUANTITY               = "QUANTITY"
    case PRICE_PER_ITEM         = "PRICE PER ITEM"
    case AMOUNT                 = "AMOUNT"
...
enum LineItemType1: String, CaseIterable {
    case PART                   = "PART"
    case SUPPLYS                = "SUPPLYS"
    case NON_STOCKABLE_ITEM     = "NON_STOCKABLE_ITEM"
}
...
class CreatedPurchaseOrderLineItem: BaseCreateItemView, Storyboarded {
    
    let viewModel = CreatedPurchaseOrderLineItemModel()
    ...
    private func getFieldsForLineItemType(at type: LineItemType1) -> [TextFieldCellData] {
        switch type {
        case .PART:
    ...
    private func updateAmountCell(){
        ...
        let cell = TextFieldCellData.init(title: LineItemCell.AMOUNT.rawValue.localize,
                                          ...
                                          isActive: false,//isEditingEnabled,
                                          keyboardType: .decimalPad,
                                          validation: .Valid/*viewModel.validatePriceToResell()*/,
                                          text: viewModel.getAmountOfLineITem())
        ...
        if let cellType = LineItemCell(rawValue:  cellData[indexPath.row].key), cellType == .TYPE {
            ...
            cell.bindCell(data: [.init(key: TypeCell.PART.rawValue,
                                ...
                                .init(key: TypeCell.NON_STOCKABLE_ITEM.rawValue,
                                      ...
                                      value: viewModel.getIsNonStockable())], 60)
            cell.delegate = self
            return cell
        }
...
extension CreatedPurchaseOrderLineItem: RadioButtonCellDelegate {
...
extension CreatedPurchaseOrderLineItem: TextFieldCellDelegate {
...
extension CreatedPurchaseOrderLineItem: TextFieldListDelegate {
