...
private enum LineItemCell: String {
    ...
    case PRICE_PER_ITEM         = "PRICE PER TEM"
    case AMOUNT                 = "AMOUNT"
...
class WorkOrderView:BaseCreateItemView, Storyboarded {
    
    let viewModel = WorkOrderViewModel()
        ...
        case .PART:
            ...
            return [
                ...
                .init(title: LineItemCell.PART.rawValue.localize,
                      ...
                      validation:viewModel.validatePart(),
                      text: partName,
...
extension WorkOrderView: RadioButtonCellDelegate {
...
extension WorkOrderView: TextFieldCellDelegate {
...
extension WorkOrderView: TextFieldListDelegate {
