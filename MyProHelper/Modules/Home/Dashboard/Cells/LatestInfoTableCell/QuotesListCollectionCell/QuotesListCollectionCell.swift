//
//  QuotesListCollectionCell.swift
//  MyProHelper
//
...
class QuotesListCollectionCell: UICollectionViewCell , SwiftDataTableDelegate {
    static let ID = String(describing: QuotesListCollectionCell.self)
    
    @IBOutlet weak private var dataTableContainerView: UIView!
    private var dataTable: SwiftDataTable!
    
    private let dataTableFields: [QuotesListFields] = [.NO_DOT,
                                                       .CUSTOMER_NAME,
                                                       .DESCRIPTION,
                                                       .PRICE_QUOTED,
                                                       .PRICE_ESTIMATE,
    ...
    private var sortField: QuotesListFields?
...
//    }
    ...
    private func fetchQuotes(reloadData: Bool) {
        ...
        service.fetchQuotes(showRemoved: isShowingRemoved, key: searchKey, sortBy: .NO_DOT, sortType: .ASCENDING, offset: offset) { [weak self] (result) in
...
extension QuotesListCollectionCell: SwiftDataTableDataSource {
