//
//  EstimatesListCollectionCell.swift
//  MyProHelper
//
//  Created by sismac010 on 28/10/21.
...
enum EstimatesListFields: String {
    case NO_DOT             = "NO_DOT"
...
class EstimatesListCollectionCell: UICollectionViewCell, SwiftDataTableDelegate {
    static let ID = String(describing: EstimatesListCollectionCell.self)
    
    @IBOutlet weak private var dataTableContainerView: UIView!
    private var dataTable: SwiftDataTable!
    
    private let dataTableFields: [EstimatesListFields] = [.NO_DOT,
                                                       .CUSTOMER_NAME,
                                                       .DESCRIPTION,
                                                       .PRICE_QUOTED,
                                                       .PRICE_ESTIMATE,
    ...
    private var sortField: EstimatesListFields?
    ...
    private func fetchEstimates(reloadData: Bool) {
        ...
        service.fetchEstimates(showRemoved: isShowingRemoved, key: searchKey, sortBy: .NO_DOT, sortType: .ASCENDING, offset: offset) { [weak self] (result) in
...
extension EstimatesListCollectionCell: SwiftDataTableDataSource {
