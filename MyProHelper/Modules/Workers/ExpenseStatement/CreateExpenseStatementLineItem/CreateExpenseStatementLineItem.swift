//
//  CreateExpenseStatementLineItem.swift
//  MyProHelper
//
...
class CreateExpenseStatementLineItem: BaseCreateItemView, Storyboarded {
    
    let viewModel = CreateExpenseStatementLineItemModel()
...
//            let partName = viewModel.getPart() != nil && !viewModel.getPart()!.isEmpty ? viewModel.getPart() : ((viewModel.getParts().count > 0) ? viewModel.getParts().first : "")
            ...
            return [
                ...
                .init(title: LineItemCell.AMOUNT.rawValue.localize,
                      ...
                      keyboardType: .decimalPad,
                      validation: .Valid,
                      text: viewModel.getAmountToReimburse())
            ]
        case .SUPPLYS:
        ...
        if let cellType = LineItemCell(rawValue:  cellData[indexPath.row].key), cellType == .TYPE {
            ...
            cell.bindCell(data: [.init(key: TypeCell.PART.rawValue,
                                ...
                                .init(key: TypeCell.NON_STOCKABLE_ITEM.rawValue,
                                      ...
                                      value: viewModel.getIsNonStockable())
                                    ],60,true)
            cell.delegate = self
            return cell
        }
...
extension CreateExpenseStatementLineItem: RadioButtonCellDelegate {
...
extension CreateExpenseStatementLineItem: TextFieldCellDelegate {
...
extension CreateExpenseStatementLineItem: TextFieldListDelegate {
